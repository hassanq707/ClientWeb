...
const InfoSection = ({ currentTypeIndex, currentText }) => {
  const getVehicleIcon = () => {
    ...
    switch (vehicleTypes[currentTypeIndex]) {
      case 'Car': return <FaCar className="text-blue-600 text-2xl sm:text-3xl md:text-4xl" />;
  ...
  return (
    <div className="text-white px-2 md:px-6 lg:px-14 text-left w-full">
      <div className="flex  justify-start items-center mb-4 sm:mb-6">
        {getVehicleIcon()}
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold ml-3 sm:ml-4">Asset</h1>
      </div>
      <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold mb-4 sm:mb-6">Central Report</h2>
